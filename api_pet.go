...
func (r ApiAddPetRequest) Execute() (Pet, *_nethttp.Response, GenericOpenAPIError) {
 ...
 * @return Pet
 */
func (a *PetApiService) AddPetExecute(r ApiAddPetRequest) (Pet, *_nethttp.Response, GenericOpenAPIError) {
	var (
...
func (r ApiUpdatePetRequest) Execute() (Pet, *_nethttp.Response, GenericOpenAPIError) {
 ...
 * @return Pet
 */
func (a *PetApiService) UpdatePetExecute(r ApiUpdatePetRequest) (Pet, *_nethttp.Response, GenericOpenAPIError) {
	var (
